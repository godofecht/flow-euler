...
double search(unsigned int current)
{
  ...
  memo_ok[current]=1; memo[current]=result;
  return result;
}

static double pe610_compute()
{
...
extern "C" double pe610_answer(void) {
  return pe610_compute();
}
